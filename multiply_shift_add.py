...
# temp_a and temp_b are used to decide when to stop (if it's finished)
# all the ak, bk, carryin are shifted once a time
# running_sum keep the final , use | to accumulate
def multiply(x, y):
    def add(a, b):
