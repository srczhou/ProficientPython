...
# assume there exists ample city, and the gas just enough for a round
# just use one loop, O(n)
# doesn't matter where to start, you can calculate negative gas
# the city with the minimum remaining_gallons is the ample city, saved in
